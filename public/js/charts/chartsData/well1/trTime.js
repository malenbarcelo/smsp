...
const datosIniciales = [
    ...
    ["POZOSHALE", 13.65, 0.02, 0.01, "red", "red"],
    ["POZOSHALE", 7.35, 0.1, 0.05, "red", "red"],
    ["POZOSHALE", 5.33, 0.29, 0.14, "red", "red"],
    ["POZOSHALE", 0, 0.97, 0.52, "red", "red"],
    ["CHONTA", 83.5,    0, 0, "blue", "blue"],
    ["CHONTA", 70.6,    0, 0, "blue", "blue"],
    ["CHONTA", 33.9,    0, 0, "blue", "blue"],
    ["CHONTA", 30,      0, 0, "blue", "blue"],
    ["CHONTA", 28.4,    0, 0, "blue", "blue"],
    ["CHONTA", 13.65,0.01, 0, "blue", "blue"],
    ["CHONTA", 7.35, 0.04, 0, "blue", "blue"],
    ["CHONTA", 5.33, 0.11, 0.01, "blue", "blue"],
    ["CHONTA", 0,    0.49, 0.06, "blue", "blue"],
    ["RAYA",100	,   0, 0, "black", "black"],
    ["RAYA",99.5,	0, 0,"black", "black"],
    ["RAYA",89.3,	0, 0,"black", "black"],
    ["RAYA",86	 ,  0, 0,"black", "black"],
    ["RAYA",83.5,	0, 0,"black", "black"],
    ["RAYA",70.6,	0, 0,"black", "black"],
    ["RAYA",33.9,	0, 0,"black", "black"],
    ["RAYA",30,     0, 0,"black", "black"],
    ["RAYA",28.4,	0, 0,"black", "black"],
    ["RAYA",13.65,	0.08, 0.01,"black", "black"],
    ["RAYA",7.35,	0.23, 0.02,"black", "black"],
    ["RAYA",5.33,	0.47, 0.02,"black", "black"],
    ["RAYA",0,      1.2, 0.13,"black", "black"],
