...
const datosIniciales = [
    ...
    ["CAPA",    36.12, 340    ,0,"blue","blue"],
    ["CAPA",    42.76, 697    ,0,"blue","blue"],
    ["CAPA", 	49.07 , 1054  ,0,"blue","blue"],
    ["CAPA", 	55.08 , 1411  ,0,"blue","blue"],
    ["CAPA", 	61.36 , 1738  ,0,"blue","blue"],
    ["CAPA", 	67.11 , 2067  ,0,"blue","blue"],
    ["CAPA", 	72.69 , 2397  ,0,"blue","blue"],
    ["CAPA", 	78.11 , 2726  ,0,"blue","blue"],
    ["CAPA", 	83.4 , 3055  ,0,"blue","blue"],
    ["CAPA", 	86.8 , 3176  ,0,"blue","blue"],
    ["CAPA", 	87.56  , 3230  ,0,"blue","blue"],
    ["CAPA", 	90.64 , 3375  ,0,"blue","blue"],
    ["CAPA", 	94.45 , 3624  ,0,"blue","blue"],
    ["CAPA", 	98.18 , 3872  ,0,"blue","blue"],
    ["CAPA", 	107.3, 4162  ,0,"blue","blue"],
    ["CAPA", 	107.92, 4200  ,0,"blue","blue"],
    ["CAPA", 	108.25, 4220  ,0,"blue","blue"],
    ["CAPA", 	115.12, 4450  ,0,"blue","blue"]
];
