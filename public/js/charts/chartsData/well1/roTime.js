...
const datosIniciales = [
    ...
    ["POZOSHALE", 13.65, 0.37, 0.01, "red", "red"],
    ["POZOSHALE", 7.35, 0.41, 0.05, "red", "red"],
    ["POZOSHALE", 5.33, 0.43, 0.14, "red", "red"],
    ["POZOSHALE", 0, 0.49, 0.52, "red", "red"],
    ["CHONTA", 83.5, 0.26, 0, "blue", "blue"],
    ["CHONTA", 70.6, 0.33, 0, "blue", "blue"],
    ["CHONTA", 33.9, 0.38, 0, "blue", "blue"],
    ["CHONTA", 30, 0.39, 0, "blue", "blue"],
    ["CHONTA", 28.4, 0.39, 0, "blue", "blue"],
    ["CHONTA", 13.65, 0.47, 0, "blue", "blue"],
    ["CHONTA", 7.35, 0.51, 0, "blue", "blue"],
    ["CHONTA", 5.33, 0.55, 0.01, "blue", "blue"],
    ["CHONTA", 0, 0.61, 0.06, "blue", "blue"],
    ["RAYA",	100	,   0.26, 0, "black", "black"],
    ["RAYA",	99.5,	0.26, 0,"black", "black"],
    ["RAYA",	89.3,	0.31, 0,"black", "black"],
    ["RAYA",	86	 ,  0.31, 0,"black", "black"],
    ["RAYA",	83.5,	0.34, 0,"black", "black"],
    ["RAYA",	70.6,	0.39, 0,"black", "black"],
    ["RAYA",	33.9,	0.44, 0,"black", "black"],
    ["RAYA",	30,     0.44, 0,"black", "black"],
    ["RAYA",	28.4,	0.45, 0,"black", "black"],
    ["RAYA",	13.65,	0.53, 0.01,"black", "black"],
    ["RAYA",	7.35,	0.58, 0.02,"black", "black"],
    ["RAYA",	5.33,	0.61, 0.02,"black", "black"],
    ["RAYA",	0,      0.67, 0.13,"black", "black"],
